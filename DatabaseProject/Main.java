 ...
 public static void main(String[] args)throws IOException{
  ...
  void init() throws IOException{
    ...
    */
    ...
    sql1  = "SELECT * FROM Subway";
    
    server.createContext("/subway", new RouteHandler(db,sql) );

    String sql2 = "";

    sql2 = "SELECT * FROM Ridership";

    server.createContext("/ridership", new RouteHandler(db,sql2) );
    // Start the server      
    server.start();
