...
public class Database{
    ...
    private boolean connect(){
        ...
        try{
            // Ensure SQLite JDBC driver is loaded (helps when jar is on classpath)
            try {
                Class.forName("org.sqlite.JDBC");
            } catch (ClassNotFoundException e) {
                if (this.debug) System.out.println("SQLite JDBC driver not found: " + e.getMessage());
                return false;
            }
    ...
    */
    ...
    When using the table format, you must provide a size for the table; use table-auto to make the columns autofit the data in the column.
    */
